...
export const collection: CollectionSection[] = [
  {
    ...
    title: "Emergence",
    description:
      "Emergence captures Messi before inevitability — the moment where talent is undeniable but legacy is still theoretical. These cards are about arrival, not validation: youth, rawness, and the first visual proof that something unprecedented has entered the sport.",
    cards: [
      {
